...
c---------------------------------------------------------------------
      do k = start(3,c)-1, cell_size(3,c)-end(3,c)
         do j = start(2,c), cell_size(2,c)-end(2,c)-1
            do i = start(1,c), cell_size(1,c)-end(1,c)-1
               ...
               fjac(2,1,i,j,k) = - ( u(2,i,j,k,c)*u(4,i,j,k,c) ) 
     >              * tmp2 
               fjac(2,2,i,j,k) = u(4,i,j,k,c) * tmp1
               fjac(2,3,i,j,k) = 0.0d+00
               fjac(2,4,i,j,k) = u(2,i,j,k,c) * tmp1
               fjac(2,5,i,j,k) = 0.0d+00

               fjac(3,1,i,j,k) = - ( u(3,i,j,k,c)*u(4,i,j,k,c) )
     >              * tmp2 
               fjac(3,2,i,j,k) = 0.0d+00
               fjac(3,3,i,j,k) = u(4,i,j,k,c) * tmp1
               fjac(3,4,i,j,k) = u(3,i,j,k,c) * tmp1
               fjac(3,5,i,j,k) = 0.0d+00

               fjac(4,1,i,j,k) = - (u(4,i,j,k,c)*u(4,i,j,k,c) * tmp2 ) 
     >              + 0.50d+00 * c2 * ( (  u(2,i,j,k,c) * u(2,i,j,k,c)
     >              + u(3,i,j,k,c) * u(3,i,j,k,c)
     >              + u(4,i,j,k,c) * u(4,i,j,k,c) ) * tmp2 )
               fjac(4,2,i,j,k) = - c2 *  u(2,i,j,k,c) * tmp1 
               fjac(4,3,i,j,k) = - c2 *  u(3,i,j,k,c) * tmp1
     ...
     >              - c1 * ( u(5,i,j,k,c) * tmp1 ) )
     >              * ( u(4,i,j,k,c) * tmp1 )
               fjac(5,2,i,j,k) = - c2 * ( u(2,i,j,k,c)*u(4,i,j,k,c) )
     >              * tmp2 
               fjac(5,3,i,j,k) = - c2 * ( u(3,i,j,k,c)*u(4,i,j,k,c) )
     >              * tmp2
               fjac(5,4,i,j,k) = c1 * ( u(5,i,j,k,c) * tmp1 )
     >              - 0.50d+00 * c2
     >              * ( (  u(2,i,j,k,c)*u(2,i,j,k,c)
     >              + u(3,i,j,k,c)*u(3,i,j,k,c)
     >              + 3.0d+00*u(4,i,j,k,c)*u(4,i,j,k,c) )
     >              * tmp2 )
               fjac(5,5,i,j,k) = c1 * u(4,i,j,k,c) * tmp1
     ...
     >              - c1345 * tmp2 * u(5,i,j,k,c)
               ...
               njac(5,3,i,j,k) = (  c3c4 - c1345 ) * tmp2 * u(3,i,j,k,c)
...
c---------------------------------------------------------------------
      do k = start(3,c), cell_size(3,c)-end(3,c)-1
         do j = start(2,c), cell_size(2,c)-end(2,c)-1
            do i = start(1,c), cell_size(1,c)-end(1,c)-1
               ...
               lhs(1,1,aa,i,j,k,c) = - tmp2 * fjac(1,1,i,j,k-1)
     >              - tmp1 * njac(1,1,i,j,k-1)
     >              - tmp1 * dz1 
               lhs(1,2,aa,i,j,k,c) = - tmp2 * fjac(1,2,i,j,k-1)
     >              - tmp1 * njac(1,2,i,j,k-1)
               lhs(1,3,aa,i,j,k,c) = - tmp2 * fjac(1,3,i,j,k-1)
     >              - tmp1 * njac(1,3,i,j,k-1)
               lhs(1,4,aa,i,j,k,c) = - tmp2 * fjac(1,4,i,j,k-1)
     >              - tmp1 * njac(1,4,i,j,k-1)
               lhs(1,5,aa,i,j,k,c) = - tmp2 * fjac(1,5,i,j,k-1)
     >              - tmp1 * njac(1,5,i,j,k-1)

               lhs(2,1,aa,i,j,k,c) = - tmp2 * fjac(2,1,i,j,k-1)
     >              - tmp1 * njac(2,1,i,j,k-1)
               lhs(2,2,aa,i,j,k,c) = - tmp2 * fjac(2,2,i,j,k-1)
     >              - tmp1 * njac(2,2,i,j,k-1)
     >              - tmp1 * dz2
               lhs(2,3,aa,i,j,k,c) = - tmp2 * fjac(2,3,i,j,k-1)
     >              - tmp1 * njac(2,3,i,j,k-1)
               lhs(2,4,aa,i,j,k,c) = - tmp2 * fjac(2,4,i,j,k-1)
     >              - tmp1 * njac(2,4,i,j,k-1)
               lhs(2,5,aa,i,j,k,c) = - tmp2 * fjac(2,5,i,j,k-1)
     >              - tmp1 * njac(2,5,i,j,k-1)

               lhs(3,1,aa,i,j,k,c) = - tmp2 * fjac(3,1,i,j,k-1)
     >              - tmp1 * njac(3,1,i,j,k-1)
               lhs(3,2,aa,i,j,k,c) = - tmp2 * fjac(3,2,i,j,k-1)
     >              - tmp1 * njac(3,2,i,j,k-1)
               lhs(3,3,aa,i,j,k,c) = - tmp2 * fjac(3,3,i,j,k-1)
     >              - tmp1 * njac(3,3,i,j,k-1)
     >              - tmp1 * dz3 
               lhs(3,4,aa,i,j,k,c) = - tmp2 * fjac(3,4,i,j,k-1)
     >              - tmp1 * njac(3,4,i,j,k-1)
               lhs(3,5,aa,i,j,k,c) = - tmp2 * fjac(3,5,i,j,k-1)
     >              - tmp1 * njac(3,5,i,j,k-1)

               lhs(4,1,aa,i,j,k,c) = - tmp2 * fjac(4,1,i,j,k-1)
     >              - tmp1 * njac(4,1,i,j,k-1)
               lhs(4,2,aa,i,j,k,c) = - tmp2 * fjac(4,2,i,j,k-1)
     >              - tmp1 * njac(4,2,i,j,k-1)
               lhs(4,3,aa,i,j,k,c) = - tmp2 * fjac(4,3,i,j,k-1)
     >              - tmp1 * njac(4,3,i,j,k-1)
               lhs(4,4,aa,i,j,k,c) = - tmp2 * fjac(4,4,i,j,k-1)
     >              - tmp1 * njac(4,4,i,j,k-1)
     >              - tmp1 * dz4
               lhs(4,5,aa,i,j,k,c) = - tmp2 * fjac(4,5,i,j,k-1)
     >              - tmp1 * njac(4,5,i,j,k-1)

               lhs(5,1,aa,i,j,k,c) = - tmp2 * fjac(5,1,i,j,k-1)
     >              - tmp1 * njac(5,1,i,j,k-1)
               lhs(5,2,aa,i,j,k,c) = - tmp2 * fjac(5,2,i,j,k-1)
     >              - tmp1 * njac(5,2,i,j,k-1)
               lhs(5,3,aa,i,j,k,c) = - tmp2 * fjac(5,3,i,j,k-1)
     >              - tmp1 * njac(5,3,i,j,k-1)
               lhs(5,4,aa,i,j,k,c) = - tmp2 * fjac(5,4,i,j,k-1)
     >              - tmp1 * njac(5,4,i,j,k-1)
               lhs(5,5,aa,i,j,k,c) = - tmp2 * fjac(5,5,i,j,k-1)
     ...
     >              + tmp1 * 2.0d+00 * dz5
               ...
               lhs(1,1,cc,i,j,k,c) =  tmp2 * fjac(1,1,i,j,k+1)
     >              - tmp1 * njac(1,1,i,j,k+1)
     >              - tmp1 * dz1
               lhs(1,2,cc,i,j,k,c) =  tmp2 * fjac(1,2,i,j,k+1)
     >              - tmp1 * njac(1,2,i,j,k+1)
               lhs(1,3,cc,i,j,k,c) =  tmp2 * fjac(1,3,i,j,k+1)
     >              - tmp1 * njac(1,3,i,j,k+1)
               lhs(1,4,cc,i,j,k,c) =  tmp2 * fjac(1,4,i,j,k+1)
     >              - tmp1 * njac(1,4,i,j,k+1)
               lhs(1,5,cc,i,j,k,c) =  tmp2 * fjac(1,5,i,j,k+1)
     >              - tmp1 * njac(1,5,i,j,k+1)

               lhs(2,1,cc,i,j,k,c) =  tmp2 * fjac(2,1,i,j,k+1)
     >              - tmp1 * njac(2,1,i,j,k+1)
               lhs(2,2,cc,i,j,k,c) =  tmp2 * fjac(2,2,i,j,k+1)
     >              - tmp1 * njac(2,2,i,j,k+1)
     >              - tmp1 * dz2
               lhs(2,3,cc,i,j,k,c) =  tmp2 * fjac(2,3,i,j,k+1)
     >              - tmp1 * njac(2,3,i,j,k+1)
               lhs(2,4,cc,i,j,k,c) =  tmp2 * fjac(2,4,i,j,k+1)
     >              - tmp1 * njac(2,4,i,j,k+1)
               lhs(2,5,cc,i,j,k,c) =  tmp2 * fjac(2,5,i,j,k+1)
     >              - tmp1 * njac(2,5,i,j,k+1)

               lhs(3,1,cc,i,j,k,c) =  tmp2 * fjac(3,1,i,j,k+1)
     >              - tmp1 * njac(3,1,i,j,k+1)
               lhs(3,2,cc,i,j,k,c) =  tmp2 * fjac(3,2,i,j,k+1)
     >              - tmp1 * njac(3,2,i,j,k+1)
               lhs(3,3,cc,i,j,k,c) =  tmp2 * fjac(3,3,i,j,k+1)
     >              - tmp1 * njac(3,3,i,j,k+1)
     >              - tmp1 * dz3
               lhs(3,4,cc,i,j,k,c) =  tmp2 * fjac(3,4,i,j,k+1)
     >              - tmp1 * njac(3,4,i,j,k+1)
               lhs(3,5,cc,i,j,k,c) =  tmp2 * fjac(3,5,i,j,k+1)
     >              - tmp1 * njac(3,5,i,j,k+1)

               lhs(4,1,cc,i,j,k,c) =  tmp2 * fjac(4,1,i,j,k+1)
     >              - tmp1 * njac(4,1,i,j,k+1)
               lhs(4,2,cc,i,j,k,c) =  tmp2 * fjac(4,2,i,j,k+1)
     >              - tmp1 * njac(4,2,i,j,k+1)
               lhs(4,3,cc,i,j,k,c) =  tmp2 * fjac(4,3,i,j,k+1)
     >              - tmp1 * njac(4,3,i,j,k+1)
               lhs(4,4,cc,i,j,k,c) =  tmp2 * fjac(4,4,i,j,k+1)
     >              - tmp1 * njac(4,4,i,j,k+1)
     >              - tmp1 * dz4
               lhs(4,5,cc,i,j,k,c) =  tmp2 * fjac(4,5,i,j,k+1)
     >              - tmp1 * njac(4,5,i,j,k+1)

               lhs(5,1,cc,i,j,k,c) =  tmp2 * fjac(5,1,i,j,k+1)
     >              - tmp1 * njac(5,1,i,j,k+1)
               lhs(5,2,cc,i,j,k,c) =  tmp2 * fjac(5,2,i,j,k+1)
     >              - tmp1 * njac(5,2,i,j,k+1)
               lhs(5,3,cc,i,j,k,c) =  tmp2 * fjac(5,3,i,j,k+1)
     >              - tmp1 * njac(5,3,i,j,k+1)
               lhs(5,4,cc,i,j,k,c) =  tmp2 * fjac(5,4,i,j,k+1)
     >              - tmp1 * njac(5,4,i,j,k+1)
               lhs(5,5,cc,i,j,k,c) =  tmp2 * fjac(5,5,i,j,k+1)
     >              - tmp1 * njac(5,5,i,j,k+1)
     >              - tmp1 * dz5
